...
import ru.dinarastepina.ulchidictionary.presentation.components.texts.TextDetailsComponent.SentencePair
...
class TextDetailsStoreFactory(
    ...
    private object ReducerImpl : Reducer<TextDetailsStore.State, Message> {
        override fun TextDetailsStore.State.reduce(msg: Message): TextDetailsStore.State =
            when (msg) {
                ...
                is Message.SentencesLoaded -> copy(
                    sentencePairs = msg.sentencePairs,
                    isLoading = false,
                    error = null
                )
